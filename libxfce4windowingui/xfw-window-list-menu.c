...
xfw_window_list_menu_class_init(XfwWindowListMenuClass *klass) {
     ...
     *
     * The lucency (roughly opacity) of icons for minimized windows.  The value
    ...
    g_object_class_install_property(gobject_class,
                                    ...
                                    g_param_spec_int("minimized-icon-lucency",
                                                     ...
                                                     "Lucency (more or less opacity) of minimized window icons",
...
add_window_menu_item(XfwWindowListMenu *menu,
    ...
    if (menu->show_icons) {
        ...
        if (icon != NULL) {
            ...
            if (xfw_window_is_minimized(window) || xfw_window_is_shaded(window)) {
