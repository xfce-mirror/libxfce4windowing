 ...
 *
 * Checks that the <systemitem class="library">libxfce4windowingui</systemitem> library
 ...
 * <systemitem class="library">libxfce4windowingui</systemitem> the extension was
 * compiled against.
 *
 * <example>
