...
xfw_window_x11_get_icon(XfwWindow *window, gint size) {
    ...
    if (priv->icon == NULL || size != priv->icon_size) {
        ...
        priv->icon = _xfw_window_x11_get_icon_for_wnck_object(icon_name, size,
...
GdkPixbuf *
_xfw_window_x11_get_icon_for_wnck_object(const gchar *icon_name, gint size, GdkPixbuf *(*get_icon)(gpointer), GdkPixbuf *(*get_mini_icon)(gpointer), gpointer wnck_object) {
    GdkPixbuf *icon = NULL;
