...
static void xfw_window_x11_constructed(GObject *obj) {
    ...
    window->priv->class_ids[0] = wnck_window_get_class_group_name(window->priv->wnck_window);
    window->priv->class_ids[1] = wnck_window_get_class_instance_name(window->priv->wnck_window);
...
class_changed(WnckWindow *wnck_window, XfwWindowX11 *window) {
    window->priv->class_ids[0] = wnck_window_get_class_group_name(wnck_window);
    window->priv->class_ids[1] = wnck_window_get_class_instance_name(wnck_window);
