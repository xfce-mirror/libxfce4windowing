...
GdkPixbuf *_xfw_window_x11_get_icon_for_wnck_object(const gchar *icon_name, gint size, GdkPixbuf *(*get_icon)(gpointer), GdkPixbuf *(*get_mini_icon)(gpointer), gpointer wnck_object);
